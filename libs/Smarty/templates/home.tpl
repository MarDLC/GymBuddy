        ...
        <ul>
            ...
            <li><a href="#">Pages</a>
                <ul class="dropdown">
                    ...
                    <li><a href="/GymBuddy/User/blog">Our blog</a></li>
                    <li><a href="/GymBuddy/User/404">404</a></li>
                </ul>
            </li>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="top-option">
                    ...
                    <a href="/GymBuddy/User/login" class="btn btn-primary">Login</a>
                </div>
            </div>
        </div>
...
<section class="hero-section">
    <div class="hs-slider owl-carousel">
        <div class="hs-item set-bg" data-setbg="/GymBuddy/libs/Smarty/img/hero/hero-1.jpg">
            <div class="container">
                <div class="row">
        ...
        <div class="hs-item set-bg" data-setbg="/GymBuddy/libs/Smarty/img/hero/hero-2.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offset-lg-6">
                        <div class="hi-text">
