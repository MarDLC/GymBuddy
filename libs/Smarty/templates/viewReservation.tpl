    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-6">
                <nav class="nav-menu">
                    <ul>
                        <li class="active"><a href="./homeVIP.html" id="home-link">Home</a></li>
                    </ul>
                </nav>
            </div>
            <div class="col-lg-3">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <div class="fs-about">
                    <div class="fa-logo">
                        <a href="homeVIP.html"><img src="../img/logo.png" alt=""></a>
                    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Aggiorna il link "Home" con la pagina di provenienza come query string
        if (referrer.includes('homeutentenor.html')) {
            homeLink.href = 'homeutentenor.html?source=previous';
        } else if (referrer.includes('utentevip.html')) {
            homeLink.href = 'utentevip.html?source=previous';
        } else {
            homeLink.href = 'homeutentenor.html'; // Default link if referrer is not recognized
        }
    });
</script>
</body>
